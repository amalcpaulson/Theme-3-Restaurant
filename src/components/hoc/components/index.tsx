			...
			<div>
				<div>
					...
					<input
						...
						value={landing.title}
						onChange={(e) =>
							dispatch(changeLandingTitle(e.target.value))
						}
					/>
				</div>
				<div>
					...
					<input
						...
						onChange={(e) =>
							dispatch(changeLandingRating(e.target.value))
						}
					/>
				</div>
				<div>
					...
					<input
						...
						onChange={(e) =>
							dispatch(changeLandingRatingCount(e.target.value))
						}
					/>
				</div>
				<div>
					...
					<textarea
						...
						onChange={(e) =>
							dispatch(changeLandingDescription(e.target.value))
						}
					/>
				</div>
				<div>
					...
					<textarea
						...
						onChange={(e) =>
							dispatch(changeLandingAddress(e.target.value))
						}
					/>
				</div>
				<div>
					...
					<textarea
						...
						onChange={(e) =>
							dispatch(changeLandingTiming(e.target.value))
						}
					/>
				</div>
			</div>
